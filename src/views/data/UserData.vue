...
export default {
  ...
  data() {
    return {
      ...
      userGrowth: [
        { month: "2023-12", value: 753 },
        { month: "2024-1", value: 653 },
        { month: "2024-2", value: 800 },
        { month: "2024-3", value: 300 },
        { month: "2024-4", value: 0 },
        { month: "2024-5", value: 353 },
      ],
      userActive: [
        { month: "2023-12", value: 753 },
        { month: "2024-1", value: 888 },
        { month: "2024-2", value: 1200 },
        { month: "2024-3", value: 650 },
        { month: "2024-4", value: 352 },
        { month: "2024-5", value: 333 },
      ],
      orderNum: [
        { month: "2023-12", value: 753 },
        { month: "2024-1", value: 777 },
        { month: "2024-2", value: 1100 },
        { month: "2024-3", value: 980 },
        { month: "2024-4", value: 230 },
        { month: "2024-5", value: 650 },
      ],
      orderType: [
        { value: 9500, name: "外卖" },
        { value: 2000, name: "堂食" },
